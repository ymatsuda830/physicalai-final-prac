...
#ifndef RUPE_CONTROL__RUPE_DRIVER_HPP_
#define RUPE_CONTROL__RUPE_DRIVER_HPP_
...
{
public:
  RupeDriver(const std::string port_name, const int baudrate, std::vector<uint8_t> id_list);
  ~RupeDriver();
...
#endif  // RUPE_CONTROL__RUPE_DRIVER_HPP_
